            ...
            <div class="text-center">
                <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 dark:text-slate-200 sm:text-5xl md:text-6xl">
                    <span class="block xl:inline">
                        <span class="mb-1 block text-black">Manage your</span>
                        <span class="bg-gradient-to-r from-indigo-400 to-pink-600 bg-clip-text text-transparent">
                            tasks easily
                        </span>
                    </span>
                    <div class="mt-2 text-black">With our
                        <span class="relative mt-3 whitespace-nowrap text-blue-600">
                            <svg aria-hidden="true" viewBox="0 0 418 42"
                            class="absolute top-3/4 left-0 right-0 m-auto h-[0.58em] w-fit fill-[#00008B]/50"
                            ...
                            <span class="relative text-[#1D8C87]">smart tools.</span>
                        </span>
                    </div>
                </h1>
                <p class="mx-auto mt-3 max-w-xl text-lg text-gray-500 sm:mt-5 md:mt-5">
                    Manage, track, and update your tasks in real-time with ease.
                </p>
                <div class="mt-5 sm:mt-8 sm:flex sm:justify-center">
                    <div class="rounded-md shadow">
                        <a class="flex w-full items-center justify-center rounded-md border border-transparent bg-[#1D8C87] px-8 py-3 text-base font-medium text-white hover:bg-[#1D8C87]/90 md:py-4 md:px-10 md:text-lg">
                            Start Tracking Now
                        </a>
                    </div>
                </div>
